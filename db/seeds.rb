...
an1 = Answer.create(body: "Test ruby answer 1", question_id: q1.id, correct: false)
an2 = Answer.create(body: "Test ruby answer 2",  question_id: q1.id, correct: true)
an3 = Answer.create(body: "Test html answer 1",  question_id: q3.id, correct: true)
an4 = Answer.create(body: "Test htnl answer 2", question_id: q3.id, correct: false)
an5 = Answer.create(body: "Test go answer 1", question_id: q4.id, correct: false)
an6 = Answer.create(body: "Test go answer 2", question_id: q4.id, correct: true)
