...
class TestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test" do
    assert_difference('Test.count') do
      post tests_url, params: { test: { category_id: @test.category_id, level: @test.level, title: @test.title } }
    end
  ...
  test "should update test" do
    patch test_url(@test), params: { test: { category_id: @test.category_id, level: @test.level, title: @test.title } }
